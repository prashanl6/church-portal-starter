...
export async function DELETE(req: Request, { params }: { params: { id: string } }) {
  ...
  try {
    ...
    // Check if there's already a pending delete approval for this notice
    ...
    await submitApproval('notice', id, 'delete', u.id);
    await audit(u.id, 'request_delete_notice', 'notice', id, existing, null);
